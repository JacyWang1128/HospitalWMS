...
{
    public partial class SelfApplyPurchaseQueryControl : BaseDataControl
    {
        public SelfApplyPurchaseQueryControl()
        {
            InitializeComponent();
        }
        ...
        private void SelfApplyPurchaseQueryControl_Load(object sender, EventArgs e)
        {
