...
{
    public partial class RestitutionQueryControl : BaseDataControl
    {
        public RestitutionQueryControl()
        {
            InitializeComponent();
        }
        ...
        private void RestitutionQueryControl_Load(object sender, EventArgs e)
        {
        ...
        private void dgvApply_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                ManageMainControl.Instance.SkipUI(typeof(RestitutionManageControl), new Model.EntityBase() { id = (long)dgvApply.Rows[e.RowIndex].Cells["编号"].Value });
            }
            else
            {
        ...
        private void uiButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                ManageMainControl.Instance.SkipUI(typeof(RestitutionManageControl), new Model.EntityBase() { id = (long)dgvApply.Rows[dgvApply.SelectedRows[0].Index].Cells["编号"].Value });
            }
            else
            {
                MessageBox.Show("该记录已审核！");
